      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="flex flex-1 items-center justify-center px-4 py-12">
          <div className="w-full max-w-md">
            <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.04] p-8 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="h-14 w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 text-sm text-white outline-none transition focus:border-violet-400/40 focus:bg-white/[0.05]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="h-14 w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 pr-12 text-sm text-white outline-none transition focus:border-violet-400/40 focus:bg-white/[0.05]"
                      />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group inline-flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-violet-500 to-cyan-400 text-sm font-semibold text-white shadow-2xl shadow-violet-500/30 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {loading ? (
                      <>
